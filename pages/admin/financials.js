...
const Existingexpense = dynamic(
  () => import("../../components/Existingexpense"),
  {
    ssr: false
  }
)
...
export default function Patient() {
  ...
  const expenses = expensesTable.filter(
    expense =>
      expense.category.toLowerCase().includes(searchTerm2.toLowerCase()) ||
      expense.title.toLowerCase().includes(searchTerm2.toLowerCase())
  )
                                            ...
                                            <form className="w-full max-w-4xl mx-auto mt-5">
                                              <div className="flex flex-col gap-6">
                                                <div className="flex flex-col md:flex-row gap-3">
                                                  {/* Expense Type */}
                                                  <div>
                                                    <label className="text-start block text-sm font-normal text-gray-700 mb-1">
                                                      Expense Type
                                                    </label>
